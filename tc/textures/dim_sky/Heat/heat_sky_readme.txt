"Heat" - skybox by Avoc @ eft-clan.com

Instructions: 
1. Place the "heat_sky" folder (containing the pictures) into your etmain/textures/ folder.
2. Place the "heat_sky.shader" in your etmain/scripts/ folder.
3. In your shaderlist.txt add "heat_sky" at the bottom.
