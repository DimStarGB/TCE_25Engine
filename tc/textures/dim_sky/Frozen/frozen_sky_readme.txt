"Frozen" - skybox by Avoc @ eft-clan.com
Rendered by Paul aka Scary - paul@dumpendiezooi.nl 

Instructions: 
1. Place the "frozen_sky" folder (containing the pictures) into your etmain/textures/ folder.
2. Place the "frozen_sky.shader" in your etmain/scripts/ folder.
3. In your shaderlist.txt add "frozen_sky" at the bottom.
