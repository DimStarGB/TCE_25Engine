"Horizon" - skybox by Avoc @ eft-clan.com

Instructions: 
1. Place the "horizon_sky" folder (containing the pictures) into your etmain/textures/ folder.
2. Place the "horizon_sky.shader" in your etmain/scripts/ folder.
3. In your shaderlist.txt add "horizon_sky" at the bottom.
